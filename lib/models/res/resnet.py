...
from lib.models._internally_replaced_utils import load_state_dict_from_url
...
def get_res_net(num_layers, pretrained=False, **kwargs):
    model = resnet_spec[num_layers](pretrained, **kwargs)
